...
@Service
public class AdministratorTecnologyRecordDeleteService implements AbstractDeleteService<Administrator, TecnologyRecord> {
	...
	@Override
	public void delete(final Request<TecnologyRecord> request, final TecnologyRecord entity) {
		assert request != null;
		assert entity != null;
